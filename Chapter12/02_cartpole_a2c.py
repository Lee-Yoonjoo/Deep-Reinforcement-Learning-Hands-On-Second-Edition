...
class PongA2c(nn.Module):
    def __init__(self, input_shape, n_actions):
        super(PongA2c, self).__init__()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--name", default="cartpole-a2c", help="Name of the run")
    ...
    net = PongA2c(envs[0].observation_space.shape, envs[0].action_space.n).to(device)
    print(net)
