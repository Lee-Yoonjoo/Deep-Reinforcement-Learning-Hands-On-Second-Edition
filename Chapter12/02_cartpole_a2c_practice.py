...
def unpack_batch(batch, net, device='gpu'):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--name", required=True, help="test")
    ...
    writer = SummaryWriter(comment="-LunarLander-" + run_name)  # args.name durch run_name ersetzt
